      ...
      <div className="flex flex-col gap-2 mt-4">
        {certifications.map((cert, i) => (
          <a
            ...
            className="flex items-center justify-between gap-2 p-3 bg-zinc-100 dark:bg-zinc-800 group cursor-pointer hover:bg-zinc-200 dark:hover:bg-zinc-700 transition-colors rounded-none"
          >
